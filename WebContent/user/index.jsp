    			...
    			<div class="box-right">
    				...
    				<div class="paging">
    					 <span class="fr">【第${pg.currPage }页/共${pg.totalPages}页】
	    					 <a href="${pageContext.request.contextPath}/BookController?op=show&pageIndex=1">首页</a>&nbsp;
	    					 <a href="${pageContext.request.contextPath}/BookController?op=show&pageIndex=${pg.currPage-1}">上一页</a>&nbsp;
	    					 <a href="${pageContext.request.contextPath}/BookController?op=show&pageIndex=${pg.currPage+1}">下一页</a>&nbsp;
	    					 <a href="${pageContext.request.contextPath}/BookController?op=show&pageIndex=${pg.totalPages}">尾页</a>&nbsp;
    					 </span>    					
    				</div>
    			</div>
    		</div>
